...
pygame.display.set_caption("Juego de la vida - SALO")
...
# Versión de un autómata que siempre aparece centrado:)
        ...
        for x in range(0, nyC):
            ...
            if newGameState[x, y] == 0:
                ...
                if pauseExec:
                    ...
                    # Con el juego ejecutándose pinto de negro las celdas
                    pygame.draw.polygon(screen, (25, 25, 25), poly, 0)

    # Actualizo el título de la ventana
    title = f"Juego de la vida - SALO - Población: {population} - Generación: {iteration}"
    if pauseExec:
        title += " - [PAUSADO]"
